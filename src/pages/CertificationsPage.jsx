          ...
          {certifications.map((cert) => (
            ...
            >
              ...
              <div
                ...
                className="relative h-44 w-full cursor-pointer overflow-hidden bg-slate-100 border-b border-slate-100 flex items-center justify-center"
              >
                {cert.imageUrl ? (
                  <img
                    src={cert.imageUrl}
              ...
              <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                <div>
                  <h3 className="text-sm font-bold text-slate-900 leading-snug line-clamp-2 group-hover:text-[#0a66c2] transition-colors">
                    {cert.name}
                  </h3>
                  {cert.issuer && (
